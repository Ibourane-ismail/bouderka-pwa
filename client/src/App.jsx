...
function App() {
  return (
    <Routes>
      ...
      <Route path="/commercial" element={<ProtectedRoute roles={['COMMERCIAL']}><CommercialLayout /></ProtectedRoute>}>
      ...
      <Route path="/atelier" element={<ProtectedRoute roles={['CHEF_ATELIER']}><AtelierLayout /></ProtectedRoute>}>
